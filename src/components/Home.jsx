      ...
      <div className="Home">
            ...
            <div className="left-section">
              ...
              <Reveal>
                <p className="home-description">
                  ...
                  Solved 1000+ DSA problems and built multiple full-stack
                  systems handling complex business logic. I don’t just write
                  code — I engineer reliable backend systems.
                </p>
              </Reveal>
            </div>
          </Reveal>
        ...
        <Reveal>
          <div className="home-page-links">
            <div className="" onClick={() => navigate("/contact-form")}>
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://drive.google.com/file/d/1iY-aRTU9JnTewdFf2Xvu-q7sN9LX-Z13/view?usp=drive_link",
                  "_blank",
                );
              }}>
              <FaCloudDownloadAlt />
