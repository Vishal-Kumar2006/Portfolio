...
import ParkEase from "../../public/ParkEase.png";
import ProConnect from "../../public/ProConnect.png";
...
const projects = [
  ...
  {
    name: " ProConnect: Professional Networking Platform",
    image: ProConnect,
    description:
      "ProConnect is a professional networking platform inspired by LinkedIn, built to help users connect, share professional updates, and showcase their career journey. It is a full-stack application powered by the MERN Stack with a Next.js frontend, designed to simulate real-world professional networking experiences.",
    techStack: "React.js, Node.js, Express.js, MongoDB, JWT, Bcrypt",
    github: "https://github.com/Vishal-Kumar2006/LinkedIn_Clone",
    demo: "https://linkedin-clone-frontned.onrender.com",
  },

  // CookSy: A Recipe Website : Not deployed (Need Deployment)
  {
