...
const projects = [
  ...
  // MeetHub: A Zoom Meetig Clone Website : Deployed (Need Check in)
  {
    ...
    video:
      "https://www.youtube.com/embed/FcJxz2RgM5Q?autoplay=1&mute=1&loop=1&playlist=FcJxz2RgM5Q",
    description:
  ...
  // WanderLust: AirBNB Clone Website : Not Deployed (Need Deployment)
  {
    ...
    video:
      "https://www.youtube.com/embed/DMmv4VMTt44?autoplay=1&mute=1&loop=1&playlist=DMmv4VMTt44",
    description:
  ...
  // Employee Shift Management : Not Deployed(Need Deployment)
  {
    ...
    video:
      "https://www.youtube.com/embed/-Q8KqKAE-1Q?autoplay=1&mute=1&loop=1&playlist=-Q8KqKAE-1Q",
    description:
  ...
  // Weather App : Deployed
  {
    ...
    video:
      "https://www.youtube.com/embed/nOzxzWlBTF4?autoplay=1&mute=1&loop=1&playlist=nOzxzWlBTF4",
    description:
